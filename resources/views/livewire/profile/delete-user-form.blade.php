        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-red-800 dark:text-red-200">
                    {{ __('¡Acción irreversible!') }}
                </h3>
                <div class="mt-2 text-sm text-red-700 dark:text-red-300">
                    <p>{{ __('Esta acción no se puede deshacer. Se eliminarán:') }}</p>
                    <ul class="mt-1 list-disc list-inside">
                        <li>{{ __('Todos tus datos personales') }}</li>
                        <li>{{ __('Tu historial de actividades') }}</li>
                        <li>{{ __('Archivos subidos (foto de perfil, etc.)') }}</li>
                    </ul>
                </div>
            </div>
        </div>
